                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="<?php echo $fetch->name?>" placeholder="Please Enter Service Name" name="name"/>
                                        </div>
										<div class="form-group">
                                            <label>Service Image</label>
                                            <input type="file" value="<?php echo $fetch->img?>" class="form-control"  name="img"/>
                                            <img src="upload/service/<?php echo $fetch->img?>" width="50px">
